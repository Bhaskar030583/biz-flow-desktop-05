...
import { Minus, Plus, ShoppingCart, Trash2, Calculator, Search, CreditCard, Banknote, SplitSquareHorizontal, User, History, Clock, Smartphone, Menu, Package, PanelRightClose, PanelRightOpen } from "lucide-react";
...
export const POSSystem: React.FC<POSSystemProps> = ({ 
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 to-blue-50 overflow-hidden font-inter">
      ...
      {/* Professional Right Sidebar - Cart - with conditional rendering */}
      {showOrderSummary && (
